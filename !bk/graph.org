...
var complexChartOption1 = {
    ...
    scales: {
        yAxes: [{
            ...
            position: "left",
            ticks: {
                max: <?php echo $max[1] + 10; ?>,
                min: <?php echo $min[1] - 10; ?>,
                stepSize: 10
            },
        }, {
            id: "y-axis-2",
            ...
            position: "right",
            ticks: {
                max: <?php echo $max[2] + 10; ?>,
                min: <?php echo $min[2] - 10; ?>,
                stepSize: 10
            },
            gridLines: {
...
var complexChartOption2 = {
    ...
    scales: {
        yAxes: [{
            ...
            position: "left",
            ticks: {
                max: <?php echo $max[3] + 10; ?>,
                min: <?php echo $min[3] - 10; ?>,
                stepSize: 10
            },
        }, {
            id: "y-axis-4",
            ...
            position: "right",
            ticks: {
                max: <?php echo $max[4] + 10; ?>,
                min: <?php echo $min[4] - 10; ?>,
                stepSize: 10
            },
            gridLines: {
                drawOnChartArea: false, 
...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      label: 'Charging equipment input power L(W)',
    ...
    {
      label: 'Charging equipment output voltage(V)',
...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    {
      label: 'Temperature inside equipment(℃)',
