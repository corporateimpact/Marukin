...
<td>
<form action="main-dev2.php" method="post" name="aForm">
...
//<*--測定値のリスト表示　開始---->
 ...
 echo '<td align="center" width="50">水温</td>';
 echo '<td align="center" width="50">DO値</td>';
 echo '<td align="center" rowspan="5" style="border-top-style: hidden; border-right-style: hidden; border-bottom-style: hidden"  width="45">';
 echo date('Y/n/j',strtotime($startdate)).'<br>～<br>'.date('Y/n/j',strtotime($enddate)).'<br>の平均値<br>';
 echo '水温　';
 if ($count <> 0) {
