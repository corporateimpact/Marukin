...
$flag = 0;
$dArray;
if(file_exists("/var/www/html/list/" . $filename)){
//該当月のデータがあれば
	$data = File("/var/www/html/list/" . $filename, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
	$num = 0;
	foreach($data as $row){
		$tmp = explode(",",$row);
		$dArray{$num} = $tmp;
...
<td width="20" align="center"><input type="text" name="txt3" size="3" style="ime-mode: disabled;" value="<?php echo $dArray[$writeline][3]; ?>">℃</td>
<td width="20" align="center"><input type="text" name="txt4" size="3" style="ime-mode: disabled;" value="<?php echo $dArray[$writeline][4]; ?>">℃</td>
<td width="20" align="center"><input type="text" name="txt5" size="3" style="ime-mode: disabled;" value="<?php echo $dArray[$writeline][5]; ?>"></td>
